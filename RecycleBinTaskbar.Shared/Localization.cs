...
namespace RecycleBinTaskbar.Shared
{
    ...
    /// description tooltip, the title/description of each Jump List entry,
    /// the words used to show a live item count, and the "emptied" notification text.
    /// </summary>
    public class LanguageStrings
    {
        ...
        /// <summary>Plural word for "items", used when showing a live count (e.g. "12 items").</summary>
        public string ItemsWord { get; set; }

        /// <summary>Shown instead of a count when the Recycle Bin is empty.</summary>
        public string EmptyLabel { get; set; }

        /// <summary>Notification body shown after successfully emptying the Recycle Bin.</summary>
        public string EmptiedNotification { get; set; }
    }
    ...
    public static class Localization
    {
        ...
        public static readonly Dictionary<string, LanguageStrings> Languages = new()
        {
            ["en"] = new LanguageStrings
            {
                ...
                ItemsWord = "items", EmptyLabel = "Empty",
                EmptiedNotification = "The Recycle Bin has been emptied."
            },
            ["es"] = new LanguageStrings
            {
                ...
                ItemsWord = "elementos", EmptyLabel = "Vacía",
                EmptiedNotification = "La papelera de reciclaje se ha vaciado."
            },
            ["fr"] = new LanguageStrings
            {
                ...
                ItemsWord = "éléments", EmptyLabel = "Vide",
                EmptiedNotification = "La corbeille a été vidée."
            },
            ["de"] = new LanguageStrings
            {
                ...
                ItemsWord = "Elemente", EmptyLabel = "Leer",
                EmptiedNotification = "Der Papierkorb wurde geleert."
            },
            ["it"] = new LanguageStrings
            {
                ...
                ItemsWord = "elementi", EmptyLabel = "Vuoto",
                EmptiedNotification = "Il cestino è stato svuotato."
            },
            ["pt"] = new LanguageStrings
            {
                ...
                ItemsWord = "itens", EmptyLabel = "Vazia",
                EmptiedNotification = "A lixeira foi esvaziada."
            },
            ["ru"] = new LanguageStrings
            {
                ...
                ItemsWord = "объектов", EmptyLabel = "Пусто",
                EmptiedNotification = "Корзина очищена."
            },
            ["zh-Hans"] = new LanguageStrings
            {
                ...
                ItemsWord = "项", EmptyLabel = "空",
                EmptiedNotification = "回收站已清空。"
            },
            ["ja"] = new LanguageStrings
            {
                ...
                ItemsWord = "個の項目", EmptyLabel = "空です",
                EmptiedNotification = "ごみ箱を空にしました。"
            },
            ["ko"] = new LanguageStrings
            {
                ...
                ItemsWord = "개 항목", EmptyLabel = "비어 있음",
                EmptiedNotification = "휴지통을 비웠습니다."
            },
            ["nl"] = new LanguageStrings
            {
                ...
                ItemsWord = "items", EmptyLabel = "Leeg",
                EmptiedNotification = "De prullenbak is geleegd."
            },
            ["pl"] = new LanguageStrings
            {
                ...
                ItemsWord = "elementów", EmptyLabel = "Pusty",
                EmptiedNotification = "Kosz został opróżniony."
            },
            ["tr"] = new LanguageStrings
            {
                ...
                ItemsWord = "öğe", EmptyLabel = "Boş",
                EmptiedNotification = "Geri dönüşüm kutusu boşaltıldı."
            },
            ["ar"] = new LanguageStrings
            {
                ...
                ItemsWord = "عناصر", EmptyLabel = "فارغة",
                EmptiedNotification = "تم إفراغ سلة المحذوفات."
            },
        };
